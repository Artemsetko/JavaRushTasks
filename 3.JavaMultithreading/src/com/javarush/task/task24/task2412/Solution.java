            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (result != 0) return result;
                    ...
                    if (result != 0) return result;
                        ...
                        profit[0] = stock1.containsKey("open") ? (Double) stock1.get("last") - (Double) stock1.get("open")
                                : (Double) stock1.get("change");
                        profit[1] = stock2.containsKey("open") ? (Double) stock2.get("last") - (Double) stock2.get("open")
                                : (Double) stock2.get("change");
                        return profit[1].compareTo(profit[0]);
                    }
                }
            }
        });
