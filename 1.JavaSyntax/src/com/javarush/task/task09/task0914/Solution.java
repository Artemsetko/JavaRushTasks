...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println(exception3.getClass().getTypeName());
        } catch (Exception2 exception2) {
            System.out.println(exception2.getClass().getTypeName());
        } catch (Exception1 exception1) {
            System.out.println(exception1.getClass().getTypeName());
        }
