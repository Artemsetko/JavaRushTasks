...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String replaceString = stringWriter.toString().replaceFirst(oneClassName, resultClassName);
        return objectMapper.readValue(new StringReader(replaceString), resultClassObject);
    }
